        ...
        <div className={styles.projectsList}>
          <div className={styles.item}>
            ...
            <div className={styles.info}>
              ...
              <span className={styles['description']}>
                A multiplayer maze solving game.
              </span>

              <p className={styles['tech']}>
                MERN Typescript Socket.io CSS-in-JS
              </p>
              <div className={styles['icons']}>
                <a
                  href="https://mazer.netlify.app/"
                  className={styles['external-link']}
                >
                  {externalLink}
                </a>
                <a
                  href="https://github.com/Am4teur/MazerMERN"
                  className={styles['external-link']}
                >
                  {github}
                </a>
          ...
          <div className={styles.item}>
            ...
            <div className={styles.info}>
              ...
              <span className={styles['description']}>
                E-shop where new and rising artists can sell their art.
              </span>

              <p className={styles['tech']}>Stripe React MUI Commerce.js</p>
              <div className={styles['icons']}>
                <a
                  href="https://risingart.netlify.app/"
                  className={styles['external-link']}
                >
                  {externalLink}
                </a>
                <a
                  href="https://github.com/Am4teur/rising-art-ecomm"
                  className={styles['external-link']}
                >
                  {github}
                </a>
